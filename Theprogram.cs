...
HOWEVER, in light of this, you are free to modify, even distribute the code, and / or improve the code on your own, even use them for your own projects.
Oh one last thing, if you wish to compile, or build the program, only build the program in C# 6 and above (but not sure which .NET version so, preferably the latest one)
